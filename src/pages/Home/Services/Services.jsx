...
const Services = () => {
    return (
        <div className='py-24'>
            ...
            <p className='text-center text-base'>We handle everything Amazon so you can focus on growing.</p>
            {/* services card */}
            <div className='grid grid-cols-2 gap-10 space-y-12 pt-14 px-25'>
                {/* card-1 */}
                <div className=''>
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <p className='text-base secondary'>Bid & Budget Optimization – Higher ROI, lower ACOS.</p>
                    </div>
                    <div className='flex items-center gap-3'>
                        <img src={baseCicle} alt="" className='border border-amber-500 rounded-full p-0.5 w-4 h-4' />
                        <p className='text-base secondary'>Bid & Budget Optimization – Higher ROI, lower ACOS.</p>
                ...
                <div className=''>
                    <div className='flex justify-between'>
                        <h1 className='text-lg primary'>Amazon Growth & Advertising</h1>
                        <img src={ranking} alt="" className='w-16' />
                    </div>
                    <img src={line} alt="" className=''/>
                    <div className='flex items-center gap-3'>
                        <img src={baseCicle} alt="" className='border border-amber-500 rounded-full p-0.5 w-4 h-4' />
                ...
                <div className=''>
                    <div className='flex justify-between'>
                        <h1 className='text-lg primary'>Amazon Growth & Advertising</h1>
                        <img src={global} alt="" className='w-16' />
                    </div>
                    <img src={line} alt="" className=''/>
                    <div className='flex items-center gap-3'>
                        <img src={baseCicle} alt="" className='border border-amber-500 rounded-full p-0.5 w-4 h-4' />
                    ...
                    <div className='flex items-center gap-3'>
                        <img src={baseCicle} alt="" className='border border-amber-500 rounded-full p-0.5 w-4 h-4' />
                        <p className=' secondary'>Bid & Budget Optimization – Higher ROI, lower ACOS.</p>
                    </div>
                </div>
            </div>
